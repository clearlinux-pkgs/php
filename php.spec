...
Source0  : http://us1.php.net/distributions/php-7.2.2.tar.xz
Source1  : http://localhost/cgit/projects/phpbench/snapshot/phpbench-0.8.2.tar.gz
Source99 : http://us1.php.net/distributions/php-7.2.2.tar.xz.asc
...
cd ..
%setup -q -n php-7.2.2
mkdir -p %{_topdir}/BUILD/php-7.2.2/phpbench
mv %{_topdir}/BUILD/phpbench-0.8.2/* %{_topdir}/BUILD/php-7.2.2/phpbench
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1517498511
