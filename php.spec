...
#
# Source0 file verified with key 0xBEC555E22A143553 (eric@sixthree.me)
#
Name     : php
Version  : 8.3.10
Release  : 320
URL      : https://us1.php.net/distributions/php-8.3.10.tar.gz
Source0  : https://us1.php.net/distributions/php-8.3.10.tar.gz
Source1  : http://localhost/cgit/projects/phpbench/snapshot/phpbench-0.8.2.tar.gz
Source2  : https://us1.php.net/distributions/php-8.3.10.tar.gz.asc
Source3  : BEC555E22A143553.pkey
Source4  : php.ini
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) BEC555E22A143553' gpg.status
%setup -q -n php-8.3.10
cd %{_builddir}
tar xf %{_sourcedir}/phpbench-0.8.2.tar.gz
cd %{_builddir}/php-8.3.10
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/* %{_builddir}/php-8.3.10/phpbench
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a php-8.3.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723654567
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/extensions/no-debug-non-zts-20230831/dba.so
/V3/usr/lib64/extensions/no-debug-non-zts-20230831/opcache.so
/V3/usr/lib64/extensions/no-debug-non-zts-20230831/sqlite3.so
/usr/lib64/extensions/no-debug-non-zts-20230831/dba.so
/usr/lib64/extensions/no-debug-non-zts-20230831/opcache.so
/usr/lib64/extensions/no-debug-non-zts-20230831/sqlite3.so
