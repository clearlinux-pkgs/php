...
#
# Source0 file verified with key 0xF9BA0ADA31CBD89E (krakjoe@php.net)
#
Name     : php
Version  : 7.1.9
Release  : 121
...
Source99 : http://us1.php.net/distributions/php-7.1.9.tar.xz.asc
...
cd ..
%setup -q -n php-7.1.9
mkdir -p %{_topdir}/BUILD/php-7.1.9/phpbench
mv %{_topdir}/BUILD/phpbench-0.8.2/* %{_topdir}/BUILD/php-7.1.9/phpbench
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
[zendopcache]
zend_extension=/usr/lib64/extensions/no-debug-non-zts-20160303/opcache.so
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/extensions/no-debug-non-zts-20160303/dba.so
/usr/lib64/extensions/no-debug-non-zts-20160303/opcache.so
