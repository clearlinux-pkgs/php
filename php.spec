...
#
# Source0 file verified with key 0x199F9DFEF6FFBAFD (patrickallaert@php.net)
#
Name     : php
Version  : 8.1.9
Release  : 266
URL      : https://us1.php.net/distributions/php-8.1.9.tar.xz
Source0  : https://us1.php.net/distributions/php-8.1.9.tar.xz
Source1  : http://localhost/cgit/projects/phpbench/snapshot/phpbench-0.8.2.tar.gz
Source2  : https://us1.php.net/distributions/php-8.1.9.tar.xz.asc
Source3  : php.ini
...
cd %{_builddir}/php-8.1.9
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/* %{_builddir}/php-8.1.9/phpbench
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
pushd ..
cp -a php-8.1.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659986837
