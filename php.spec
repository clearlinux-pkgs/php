...
Source99 : http://us1.php.net/distributions/php-7.2.11.tar.xz.asc
...
cd ..
%setup -q -T -D -n php-7.2.11 -b 1
mkdir -p phpbench
mv %{_topdir}/BUILD/phpbench-0.8.2/* %{_topdir}/BUILD/php-7.2.11/phpbench
%patch2 -p1
%patch3 -p1
%patch4 -p1
