...
Source2  : https://us1.php.net/distributions/php-8.3.3.tar.xz.asc
Source3  : php.ini
...
cd %{_builddir}/php-8.3.3
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/* %{_builddir}/php-8.3.3/phpbench
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a php-8.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708025848
