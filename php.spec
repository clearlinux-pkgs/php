...
Source2  : https://us1.php.net/distributions/php-8.3.8.tar.gz.asc
...
cd %{_builddir}/php-8.3.8
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/* %{_builddir}/php-8.3.8/phpbench
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a php-8.3.8 buildavx2
popd
