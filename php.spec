...
Source0  : https://us1.php.net/distributions/php-8.4.5.tar.gz
Source1  : http://localhost/cgit/projects/phpbench/snapshot/phpbench-0.8.2.tar.gz
Source2  : https://us1.php.net/distributions/php-8.4.5.tar.gz.asc
...
cd %{_builddir}/php-8.4.5
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/. %{_builddir}/php-8.4.5/phpbench
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a php-8.4.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742448912
