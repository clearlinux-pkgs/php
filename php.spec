...
Source2  : https://us1.php.net/distributions/php-8.2.0.tar.xz.asc
Source3  : php.ini
...
cd %{_builddir}/php-8.2.0
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/* %{_builddir}/php-8.2.0/phpbench
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
pushd ..
cp -a php-8.2.0 buildavx2
popd
