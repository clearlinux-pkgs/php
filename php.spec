...
#
# Source0 file verified with key 0x659A97C9CF2A795A (sergey@php.net)
#
Name     : php
Version  : 8.2.11
Release  : 296
...
Source2  : https://us1.php.net/distributions/php-8.2.11.tar.xz.asc
Source3  : php.ini
...
%prep
%setup -q -n php-8.2.11
cd %{_builddir}
tar xf %{_sourcedir}/phpbench-0.8.2.tar.gz
cd %{_builddir}/php-8.2.11
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/* %{_builddir}/php-8.2.11/phpbench
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a php-8.2.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695928045
