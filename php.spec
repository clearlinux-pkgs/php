...
Source0  : https://us2.php.net/distributions/php-7.2.3.tar.xz
...
cd ..
%setup -q -n php-7.2.3
mkdir -p %{_topdir}/BUILD/php-7.2.3/phpbench
mv %{_topdir}/BUILD/phpbench-0.8.2/* %{_topdir}/BUILD/php-7.2.3/phpbench
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1522248923
