...
Source99 : http://us1.php.net/distributions/php-7.2.8.tar.xz.asc
...
cd ..
%setup -q -n php-7.2.8
mkdir -p %{_topdir}/BUILD/php-7.2.8/phpbench
mv %{_topdir}/BUILD/phpbench-0.8.2/* %{_topdir}/BUILD/php-7.2.8/phpbench
%patch2 -p1
%patch3 -p1
%patch4 -p1
