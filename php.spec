...
Source0  : https://www.php.net/distributions/php-7.4.2.tar.xz
Source1  : http://localhost/cgit/projects/phpbench/snapshot/phpbench-0.8.2.tar.gz
Source2  : https://www.php.net/distributions/php-7.4.2.tar.xz.asc
Source3  : php.ini
...
Patch2: 0002-Disable-RC4-algorithm-fallback-for-signature-checks.patch
...
cd %{_builddir}/php-7.4.2
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/* %{_builddir}/php-7.4.2/phpbench
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579898491
...
cp %{_builddir}/php-7.4.2/LICENSE %{buildroot}/usr/share/package-licenses/php/27b46923d7341b6bb717d06db4850b1180d565b2
cp %{_builddir}/php-7.4.2/TSRM/LICENSE %{buildroot}/usr/share/package-licenses/php/1ffc27ce3b11cd061bfd4882c22602560f2c7931
cp %{_builddir}/php-7.4.2/Zend/LICENSE %{buildroot}/usr/share/package-licenses/php/e984a92e965a699a63ee739a7eb8b8e2c24cc398
cp %{_builddir}/php-7.4.2/ext/bcmath/libbcmath/LICENSE %{buildroot}/usr/share/package-licenses/php/6e79d515230676f96463980432059843a8d75802
cp %{_builddir}/php-7.4.2/ext/date/lib/LICENSE.rst %{buildroot}/usr/share/package-licenses/php/c5ccb7505042b760f304032e80e1e192d4899d02
cp %{_builddir}/php-7.4.2/ext/fileinfo/libmagic/LICENSE %{buildroot}/usr/share/package-licenses/php/3e3925d5a55f4b83a99f9c960214e3f6024a2469
cp %{_builddir}/php-7.4.2/ext/gd/tests/Rochester-Regular.otf.LICENSE.txt %{buildroot}/usr/share/package-licenses/php/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/php-7.4.2/ext/mbstring/libmbfl/LICENSE %{buildroot}/usr/share/package-licenses/php/41146e72d0f13320af7a165c543a7cbd59d56323
cp %{_builddir}/php-7.4.2/ext/oci8/LICENSE %{buildroot}/usr/share/package-licenses/php/27b46923d7341b6bb717d06db4850b1180d565b2
cp %{_builddir}/php-7.4.2/phpbench/LICENSE %{buildroot}/usr/share/package-licenses/php/9e0b81b219f2fac6ebb6200b8df03e6879cbc80f
cp %{_builddir}/php-7.4.2/sapi/fpm/LICENSE %{buildroot}/usr/share/package-licenses/php/d0cbc5492bdea8a8437b7c2b6c0ad66947a576a5
%make_install
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/extensions/no-debug-non-zts-20190902/dba.so
/usr/lib64/extensions/no-debug-non-zts-20190902/opcache.so
/usr/lib64/extensions/no-debug-non-zts-20190902/sqlite3.so

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/php/1ffc27ce3b11cd061bfd4882c22602560f2c7931
/usr/share/package-licenses/php/27b46923d7341b6bb717d06db4850b1180d565b2
