...
Source0  : http://us1.php.net/distributions/php-8.0.6.tar.xz
Source1  : http://localhost/cgit/projects/phpbench/snapshot/phpbench-0.8.2.tar.gz
Source2  : http://us1.php.net/distributions/php-8.0.6.tar.xz.asc
Source3  : php.ini
...
cd %{_builddir}/php-8.0.6
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/* %{_builddir}/php-8.0.6/phpbench
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620411229
...
cp %{_builddir}/php-8.0.6/LICENSE %{buildroot}/usr/share/package-licenses/php/8c12894c6c25a643d94339ff9cdf591806fbd052
cp %{_builddir}/php-8.0.6/TSRM/LICENSE %{buildroot}/usr/share/package-licenses/php/1ffc27ce3b11cd061bfd4882c22602560f2c7931
cp %{_builddir}/php-8.0.6/Zend/LICENSE %{buildroot}/usr/share/package-licenses/php/e984a92e965a699a63ee739a7eb8b8e2c24cc398
cp %{_builddir}/php-8.0.6/ext/bcmath/libbcmath/LICENSE %{buildroot}/usr/share/package-licenses/php/6e79d515230676f96463980432059843a8d75802
cp %{_builddir}/php-8.0.6/ext/date/lib/LICENSE.rst %{buildroot}/usr/share/package-licenses/php/c5ccb7505042b760f304032e80e1e192d4899d02
cp %{_builddir}/php-8.0.6/ext/fileinfo/libmagic/LICENSE %{buildroot}/usr/share/package-licenses/php/3e3925d5a55f4b83a99f9c960214e3f6024a2469
cp %{_builddir}/php-8.0.6/ext/gd/tests/Rochester-Regular.otf.LICENSE.txt %{buildroot}/usr/share/package-licenses/php/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/php-8.0.6/ext/mbstring/libmbfl/LICENSE %{buildroot}/usr/share/package-licenses/php/41146e72d0f13320af7a165c543a7cbd59d56323
cp %{_builddir}/php-8.0.6/ext/oci8/LICENSE %{buildroot}/usr/share/package-licenses/php/8c12894c6c25a643d94339ff9cdf591806fbd052
cp %{_builddir}/php-8.0.6/ext/opcache/jit/libudis86/LICENSE %{buildroot}/usr/share/package-licenses/php/5cfc18f7533f0a6d802dc838e806f24604759484
cp %{_builddir}/php-8.0.6/sapi/fpm/LICENSE %{buildroot}/usr/share/package-licenses/php/d0cbc5492bdea8a8437b7c2b6c0ad66947a576a5
