...
Source2  : https://us1.php.net/distributions/php-8.2.5.tar.xz.asc
Source3  : php.ini
...
cd %{_builddir}/php-8.2.5
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/* %{_builddir}/php-8.2.5/phpbench
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
pushd ..
cp -a php-8.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683221181
