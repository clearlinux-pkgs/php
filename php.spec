...
Source0  : https://us1.php.net/distributions/php-8.2.6.tar.xz
Source1  : http://localhost/cgit/projects/phpbench/snapshot/phpbench-0.8.2.tar.gz
Source2  : https://us1.php.net/distributions/php-8.2.6.tar.xz.asc
Source3  : php.ini
...
cd %{_builddir}/php-8.2.6
mkdir -p phpbench
cp -r %{_builddir}/phpbench-0.8.2/* %{_builddir}/php-8.2.6/phpbench
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
pushd ..
cp -a php-8.2.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685573693
